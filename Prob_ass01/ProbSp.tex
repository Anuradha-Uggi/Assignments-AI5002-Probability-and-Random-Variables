...
\begin{tikzpicture}
   \begin{axis}[axis lines=left,xlabel={s},ylabel={analytical plot of $M_z(s)$}]
     \addplot[domain=-10:10,samples=40,color=red]{e^(-(x^2))/2};
   \end{axis}
\end{tikzpicture}
\begin{figure}[h]
    \centering
    \includegraphics[width=0.5\textwidth]{rvsp.png}
    \label{}
\end{figure}
\section{Conclusion}
